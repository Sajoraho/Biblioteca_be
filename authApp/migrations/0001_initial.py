...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('role_choose', models.CharField(choices=[('AD', 'Administrador'), ('BI', 'Bibliotecario'), ('ES', 'Estudiante')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Register',
            fields=[
                ...
                ('address', models.CharField(max_length=30, verbose_name='Adress')),
